...
public class DBService {
	...
	public void InstantiateTestDatabase() throws ParseException {
		...
		Cliente cli2 = new Cliente(null, "Ana Claudia", "ana@gmail.com", "91009068083", TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenidas Matos", "105", "Sala 800", "Centro", "3877702", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenidas Floriano", "2106", null, "Centro", "2877702", cli2, c2);
